...
namespace COREBAK.PropiedadDetalle_.CasosUso.Web.RegistrarPropiedadDetalle.Aplicacion.Dto
{
    public class RegistrarPropiedadDetalleDTO
    {
        ...
        public List<int>? OrdenesFotos { get; set; }
    }
